...
const socialLinks = [
  {
    id: 1,
    label: 'Instagram',
    href: 'https://www.instagram.com/panduranginn_101?igsh=bnk1cHFnZmZveGRh',
    icon: (
  ...
  },
  {
    id: 3,
    label: 'Email',
    href: 'mailto:panduranginn@gmail.com',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="18" height="18">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-contact-list">
              ...
              <li>
                ...
                <a href="tel:+918855823636" className="footer-contact-link">+91 88558 23636</a><br />
                <a href="tel:+918090406999" className="footer-contact-link">+91 80904 06999</a>
              </li>
              <li>
                <span className="footer-contact-icon">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="16" height="16">
                ...
                <a href="mailto:panduranginn@gmail.com" className="footer-contact-link">panduranginn@gmail.com</a>
              </li>
            </ul>
          </div>
